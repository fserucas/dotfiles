;;; Got from https://codeberg.org/TristanCacqueray/dot-files
...
;; URL: https://codeberg.org/TristanCacqueray/dot-files/src/branch/master/home/.config/emacs/lisp
...
(defun giturl-to-dir (url)
  ...
  (let*
      ((url (if (string-equal (substring url 0 4) "git@") (concat "foo://" url) url))
